...
public abstract class BaseScreen implements Screen, InputProcessor {
    ...
    public BaseScreen(BaseGame g) {
        ...
        Texture avatar1 = new Texture(Gdx.files.internal("core/assets/Avatars/elephant.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage1 = new Image(avatar1);
        Texture avatar2 = new Texture(Gdx.files.internal("core/assets/Avatars/giraffe.png"));
        avatar2.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        final Image avatarImage2 = new Image(avatar2);
        Texture avatar3 = new Texture(Gdx.files.internal("core/assets/Avatars/hippo.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage3 = new Image(avatar3);
        Texture avatar4 = new Texture(Gdx.files.internal("core/assets/Avatars/monkey.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage4 = new Image(avatar4);
        Texture avatar5 = new Texture(Gdx.files.internal("core/assets/Avatars/panda.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage5 = new Image(avatar5);
        Texture avatar6 = new Texture(Gdx.files.internal("core/assets/Avatars/parrot.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage6 = new Image(avatar6);
        Texture avatar7 = new Texture(Gdx.files.internal("core/assets/Avatars/penguin.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage7 = new Image(avatar7);
        Texture avatar8 = new Texture(Gdx.files.internal("core/assets/Avatars/pig.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage8 = new Image(avatar8);
        Texture avatar9 = new Texture(Gdx.files.internal("core/assets/Avatars/rabbit.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Image avatarImage9 = new Image(avatar9);
        Texture avatar10 = new Texture(Gdx.files.internal("core/assets/Avatars/snake.png"));
        avatar1.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
